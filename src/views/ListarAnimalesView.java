...
public class ListarAnimalesView extends javax.swing.JFrame {
    ...
    public ListarAnimalesView() {
        initComponents();
        listarAnimales();
        getContentPane().setBackground(new Color(85, 107, 47)); // verde tipo bosque
    }
    ...
    private void initComponents() {
        ...
        calcularComida.setForeground(new java.awt.Color(0, 102, 51));
        calcularComida.setText("Calcular Comida");
        calcularComida.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 102, 51), 3));
        ...
        panel.setBackground(new java.awt.Color(117, 175, 123));
